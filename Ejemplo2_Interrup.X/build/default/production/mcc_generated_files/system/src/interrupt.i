...
extern volatile _Bool Flag1,Flag2,Flag3;
uint8_t i,j,k;
...
# 96 "mcc_generated_files/system/src/interrupt.c"
...
# 131 "mcc_generated_files/system/src/interrupt.c"
void __attribute__((picinterrupt(("low_priority")))) INTERRUPT_InterruptManagerLow (void)
{

    if(PIE6bits.INT1IE == 1 && PIR6bits.INT1IF == 1)
    {
        INT1_ISR();
         for (k = 0; k < 10; k++) {
            do { LATFbits.LATF1 = ~LATFbits.LATF1; } while(0);
