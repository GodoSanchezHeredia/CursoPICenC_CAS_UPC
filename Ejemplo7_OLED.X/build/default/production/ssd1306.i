...
# 41 "./mcc_generated_files/system/../i2c_host/i2c1.h"
...
# 41 "./mcc_generated_files/system/../i2c_host/i2c1.h" 2
...
void SSD1306_ScrollRight(uint8_t start_row, uint8_t end_row)
{
  ssd1306_I2C_Write(0x3c, 0x00, (0x26));
  ssd1306_I2C_Write(0x3c, 0x00, (0x00));
  ssd1306_I2C_Write(0x3c, 0x00, (start_row));
  ssd1306_I2C_Write(0x3c, 0x00, (0X00));
  ssd1306_I2C_Write(0x3c, 0x00, (end_row));
  ssd1306_I2C_Write(0x3c, 0x00, (0X00));
  ssd1306_I2C_Write(0x3c, 0x00, (0XFF));
  ssd1306_I2C_Write(0x3c, 0x00, (0x2F));
}


void SSD1306_ScrollLeft(uint8_t start_row, uint8_t end_row)
{
  ssd1306_I2C_Write(0x3c, 0x00, (0x27));
  ssd1306_I2C_Write(0x3c, 0x00, (0x00));
  ssd1306_I2C_Write(0x3c, 0x00, (start_row));
  ssd1306_I2C_Write(0x3c, 0x00, (0X00));
  ssd1306_I2C_Write(0x3c, 0x00, (end_row));
...
void SSD1306_Scrolldiagright(uint8_t start_row, uint8_t end_row)
{
  ssd1306_I2C_Write(0x3c, 0x00, (0xA3));
  ssd1306_I2C_Write(0x3c, 0x00, (0x00));
  ssd1306_I2C_Write(0x3c, 0x00, (64));

  ssd1306_I2C_Write(0x3c, 0x00, (0x29));
  ssd1306_I2C_Write(0x3c, 0x00, (0x00));
  ssd1306_I2C_Write(0x3c, 0x00, (start_row));
  ssd1306_I2C_Write(0x3c, 0x00, (0X00));
  ssd1306_I2C_Write(0x3c, 0x00, (end_row));
  ssd1306_I2C_Write(0x3c, 0x00, (0x01));
  ssd1306_I2C_Write(0x3c, 0x00, (0x2F));
}
...
void SSD1306_Scrolldiagleft(uint8_t start_row, uint8_t end_row)
{
  ...
  ssd1306_I2C_Write(0x3c, 0x00, (0x2A));
  ssd1306_I2C_Write(0x3c, 0x00, (0x00));
  ssd1306_I2C_Write(0x3c, 0x00, (start_row));
  ssd1306_I2C_Write(0x3c, 0x00, (0X00));
  ssd1306_I2C_Write(0x3c, 0x00, (end_row));
...
void SSD1306_Stopscroll(void)
{
 ssd1306_I2C_Write(0x3c, 0x00, (0x2E));
}
...
void SSD1306_InvertDisplay (int i)
{
  if (i) ssd1306_I2C_Write(0x3c, 0x00, (0xA7));

  else ssd1306_I2C_Write(0x3c, 0x00, (0xA6));
...
uint8_t SSD1306_Init(void) {
 ...
 ssd1306_I2C_Write(0x3c, 0x00, (0xAE));
 ssd1306_I2C_Write(0x3c, 0x00, (0x20));
 ssd1306_I2C_Write(0x3c, 0x00, (0x10));
 ssd1306_I2C_Write(0x3c, 0x00, (0xB0));
 ssd1306_I2C_Write(0x3c, 0x00, (0xC8));
 ssd1306_I2C_Write(0x3c, 0x00, (0x00));
 ssd1306_I2C_Write(0x3c, 0x00, (0x10));
 ssd1306_I2C_Write(0x3c, 0x00, (0x40));
 ssd1306_I2C_Write(0x3c, 0x00, (0x81));
 ssd1306_I2C_Write(0x3c, 0x00, (0xFF));
 ssd1306_I2C_Write(0x3c, 0x00, (0xA1));
 ssd1306_I2C_Write(0x3c, 0x00, (0xA6));
 ssd1306_I2C_Write(0x3c, 0x00, (0xA8));
 ssd1306_I2C_Write(0x3c, 0x00, (0x3F));
 ssd1306_I2C_Write(0x3c, 0x00, (0xA4));
 ssd1306_I2C_Write(0x3c, 0x00, (0xD3));
 ssd1306_I2C_Write(0x3c, 0x00, (0x00));
 ssd1306_I2C_Write(0x3c, 0x00, (0xD5));
 ssd1306_I2C_Write(0x3c, 0x00, (0xF0));
 ssd1306_I2C_Write(0x3c, 0x00, (0xD9));
 ssd1306_I2C_Write(0x3c, 0x00, (0x22));
 ssd1306_I2C_Write(0x3c, 0x00, (0xDA));
 ssd1306_I2C_Write(0x3c, 0x00, (0x12));
 ssd1306_I2C_Write(0x3c, 0x00, (0xDB));
 ssd1306_I2C_Write(0x3c, 0x00, (0x20));
 ssd1306_I2C_Write(0x3c, 0x00, (0x8D));
 ssd1306_I2C_Write(0x3c, 0x00, (0x14));
...
void SSD1306_UpdateScreen(void) {
 ...
 for (m = 0; m < 8; m++) {
  ssd1306_I2C_Write(0x3c, 0x00, (0xB0 + m));
  ssd1306_I2C_Write(0x3c, 0x00, (0x00));
  ssd1306_I2C_Write(0x3c, 0x00, (0x10));


  ssd1306_I2C_WriteMulti(0x3c, 0x40, &SSD1306_Buffer[128 * m], 128);
 }
}
