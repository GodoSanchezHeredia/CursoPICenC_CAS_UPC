...
# 198 "./mcc_generated_files/system/pins.h"
...
void ILI9341_DrawColorBurst(uint16_t color, uint32_t size)
{
 ...
 if(SendingInBlock != 0)
 {
  for(uint32_t j = 0; j < (SendingInBlock); j++)
  {
            ...
            SPI1_BufferWrite(BurstBuffer, BufferSize);
  }
 }


     SPI1_BufferWrite(BurstBuffer, RemainderFromBlock);
