...
# 1 "./mcc_generated_files/spi/spi1.h" 1
# 43 "./mcc_generated_files/spi/spi1.h"
# 1 "C:\\Program Files\\Microchip\\xc8\\v2.46\\pic\\include\\c99\\stdbool.h" 1 3
# 43 "./mcc_generated_files/spi/spi1.h" 2

# 1 "./mcc_generated_files/spi/spi_interface.h" 1
# 39 "./mcc_generated_files/spi/spi_interface.h"
...
# 44 "./mcc_generated_files/spi/spi1.h" 2
...
# 120 "./mcc_generated_files/spi/spi1.h"
typedef enum
{
    HOST_CONFIG,
    SPI1_DEFAULT
...
# 150 "./mcc_generated_files/spi/spi1.h"
...
# 167 "./mcc_generated_files/spi/spi1.h"
void SPI1_BufferExchange(void * bufferData, size_t bufferSize);
# 176 "./mcc_generated_files/spi/spi1.h"
void SPI1_BufferWrite(void * bufferData, size_t bufferSize);
# 185 "./mcc_generated_files/spi/spi1.h"
...
# 218 "./mcc_generated_files/spi/spi1.h"
_Bool SPI1_IsRxReady(void);
# 227 "./mcc_generated_files/spi/spi1.h"
_Bool SPI1_IsTxReady(void);
# 7 "./ILI9341_STM32_Driver.h" 2
...
# 2 "ILI9341_STM32_Driver.c" 2
# 1 "./mcc_generated_files/system/pins.h" 1
# 218 "./mcc_generated_files/system/pins.h"
...
# 4 "ILI9341_STM32_Driver.c" 2
 volatile uint16_t LCD_HEIGHT = 240;
volatile uint16_t LCD_WIDTH = 320;

void HAL_SPI_TxCpltCallback(uint8_t hspi)
{
...
static void ILI9341_SPI_TxBuffer(uint8_t *buffer, uint16_t len)
{
 ...
 SPI1_Host.BufferExchange( buffer, len);
...
void ILI9341_DrawColorBurst(uint16_t color, uint32_t size)
{
 ...
 if(SendingInBlock != 0)
 {
  for(uint32_t j = 0; j < (SendingInBlock); j++)
  {
            ...
            SPI1_Host.BufferExchange(BurstBuffer, BufferSize);
  }
 }


     SPI1_Host.BufferExchange(BurstBuffer, RemainderFromBlock);
