...
# 218 "./mcc_generated_files/system/../system/pins.h"
...
# 1 "./ILI9341_STM32_Driver.h" 1




# 1 "./mcc_generated_files/spi/spi_polling_types.h" 1
# 44 "./mcc_generated_files/spi/spi_polling_types.h"
typedef struct
{
    uint8_t con0;
    uint8_t con1;
...
# 6 "./ILI9341_STM32_Driver.h" 2
# 47 "./ILI9341_STM32_Driver.h"
...
ILI9341_DrawText("CURSO STM32", Arial_Narrow15x19, 80, 100, 0x0000, 0xF81F);
_delay((unsigned long)((500)*(64000000/4000.0)));

ILI9341_FillScreen(0x0000 );
_delay((unsigned long)((1000)*(64000000/4000.0)));
ILI9341_FillScreen(0x000F );
_delay((unsigned long)((1000)*(64000000/4000.0)));
ILI9341_FillScreen( 0x03E0 );
_delay((unsigned long)((1000)*(64000000/4000.0)));
ILI9341_FillScreen( 0x03EF );
_delay((unsigned long)((1000)*(64000000/4000.0)));
ILI9341_FillScreen( 0x7800 );
_delay((unsigned long)((1000)*(64000000/4000.0)));
ILI9341_FillScreen(0x780F );
_delay((unsigned long)((1000)*(64000000/4000.0)));
ILI9341_FillScreen( 0x7BE0 );
_delay((unsigned long)((1000)*(64000000/4000.0)));
ILI9341_FillScreen( 0xC618);
_delay((unsigned long)((1000)*(64000000/4000.0)));
ILI9341_FillScreen( 0x7BEF );
_delay((unsigned long)((1000)*(64000000/4000.0)));
ILI9341_FillScreen( 0x001F );
_delay((unsigned long)((1000)*(64000000/4000.0)));
ILI9341_FillScreen( 0x07E0 );
_delay((unsigned long)((1000)*(64000000/4000.0)));
ILI9341_FillScreen( 0x07FF );
_delay((unsigned long)((1000)*(64000000/4000.0)));
ILI9341_FillScreen( 0xF800 );
_delay((unsigned long)((1000)*(64000000/4000.0)));
ILI9341_FillScreen( 0xF81F );
_delay((unsigned long)((1000)*(64000000/4000.0)));
ILI9341_FillScreen( 0xFFE0 );
_delay((unsigned long)((1000)*(64000000/4000.0)));
ILI9341_FillScreen( 0xFFFF );
_delay((unsigned long)((1000)*(64000000/4000.0)));
ILI9341_FillScreen(0xAFE5 );
_delay((unsigned long)((1000)*(64000000/4000.0)));
ILI9341_FillScreen( 0xF81F );
_delay((unsigned long)((1000)*(64000000/4000.0)));
ILI9341_FillScreen( 0xFFFF );
...
for (var = 0; var < 10; ++var) {
 ...
 ILI9341_DrawText(Buffer, Arial_Narrow12x16, 10, 10, 0x0000, 0xFFFF);
 ILI9341_DrawText(Buffer, Arial_Narrow12x16, 10, 30, 0x001F, 0xFFFF);
 ILI9341_DrawText(Buffer, Arial_Narrow12x16, 10, 50, 0xF800, 0xFFFF);
 ILI9341_DrawText(Buffer, Arial_Narrow12x16, 10, 70, 0x07E0, 0xFFFF);
 ILI9341_DrawText(Buffer, Arial_Narrow12x16, 10, 90, 0x7800, 0xFFFF);
 ILI9341_DrawText(Buffer, Arial_Narrow12x16, 10, 110, 0xFFFF, 0x0000);
 ILI9341_DrawText(Buffer, Arial_Narrow12x16, 10, 130, 0xF800, 0x0000);
_delay((unsigned long)((500)*(64000000/4000.0)));
}
_delay((unsigned long)((1000)*(64000000/4000.0)));
ILI9341_FillScreen( 0xFFFF );
ILI9341_DrawVLine(160, 40, 200, 0xF800);
_delay((unsigned long)((1000)*(64000000/4000.0)));

ILI9341_FillScreen( 0xFFFF );
ILI9341_DrawHLine(50, 120, 200, 0xF800);
_delay((unsigned long)((1000)*(64000000/4000.0)));

ILI9341_FillScreen( 0xFFFF );
ILI9341_DrawHollowCircle(160, 120, 80, 0x7800);
_delay((unsigned long)((1000)*(64000000/4000.0)));

ILI9341_FillScreen( 0xFFFF );
ILI9341_DrawFilledCircle(160, 120, 50, 0xF800);
_delay((unsigned long)((1000)*(64000000/4000.0)));
